...
pub fn print(a1: String, a2: String, a3: String, a4: String) -> Result<(), String> {
    let c1 = hex_to_color(u32::from_str_radix(a1.as_str(), 16).unwrap_or(0));
    let c2 = hex_to_color(u32::from_str_radix(a2.as_str(), 16).unwrap_or(0));
    let n = (u32::from_str_radix(a3.as_str(), 10).unwrap());
    let msg = a4;
